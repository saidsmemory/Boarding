		...
		<div class="header">
			<nav>
				<ul class="nav nav-pills pull-right">
					<li class="noneli" style="display: none;"><a href="#">HOME</a></li>
					<li class="noneli" style="display: none;"><a href="#">LOGIN</a></li>
					<li class="noneli" style="display: none;"><a href="#">BOARD</a></li>
			...
			<h3 class="text-muted">Project BBB</h3>
